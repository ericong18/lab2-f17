...
80101efc:	e8 5f e4 ff ff       	call   80100360 <panic>
    panic("dirlink");
80101f01:	c7 04 24 46 75 10 80 	movl   $0x80107546,(%esp)
...
80103e94:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
    ...
    cprintf("\n");
80103e98:	c7 04 24 5f 77 10 80 	movl   $0x8010775f,(%esp)
...
80103eba:	83 f8 05             	cmp    $0x5,%eax
      state = "???";
80103ebd:	ba e0 73 10 80       	mov    $0x801073e0,%edx
    if(p->state >= 0 && p->state < NELEM(states) && states[p->state])
80103ec2:	77 11                	ja     80103ed5 <procdump+0x55>
80103ec4:	8b 14 85 40 74 10 80 	mov    -0x7fef8bc0(,%eax,4),%edx
      state = "???";
80103ecb:	b8 e0 73 10 80       	mov    $0x801073e0,%eax
...
80103ee0:	c7 04 24 e4 73 10 80 	movl   $0x801073e4,(%esp)
...
8010466d:	8b 14 85 c0 74 10 80 	mov    -0x7fef8b40(,%eax,4),%edx
...
80104696:	c7 04 24 91 74 10 80 	movl   $0x80107491,(%esp)
...
80104820:	c7 44 24 04 3c 75 10 	movl   $0x8010753c,0x4(%esp)
80104827:	80 
...
8010483b:	c7 44 24 04 3b 75 10 	movl   $0x8010753b,0x4(%esp)
80104842:	80 
...
80104851:	79 89                	jns    801047dc <create+0xdc>
      panic("create dots");
80104853:	c7 04 24 2f 75 10 80 	movl   $0x8010752f,(%esp)
8010485a:	e8 01 bb ff ff       	call   80100360 <panic>
    panic("create: dirlink");
8010485f:	c7 04 24 3e 75 10 80 	movl   $0x8010753e,(%esp)
80104866:	e8 f5 ba ff ff       	call   80100360 <panic>
    panic("create: ialloc");
8010486b:	c7 04 24 20 75 10 80 	movl   $0x80107520,(%esp)
...
80104c11:	c7 44 24 04 3c 75 10 	movl   $0x8010753c,0x4(%esp)
80104c18:	80 
...
80104c29:	c7 44 24 04 3b 75 10 	movl   $0x8010753b,0x4(%esp)
80104c30:	80 
...
80104d7d:	c7 04 24 60 75 10 80 	movl   $0x80107560,(%esp)
80104d84:	e8 d7 b5 ff ff       	call   80100360 <panic>
    panic("unlink: writei");
80104d89:	c7 04 24 72 75 10 80 	movl   $0x80107572,(%esp)
80104d90:	e8 cb b5 ff ff       	call   80100360 <panic>
    panic("unlink: nlink < 1");
80104d95:	c7 04 24 4e 75 10 80 	movl   $0x8010754e,(%esp)
...
80105283:	e8 38 1b 00 00       	call   80106dc0 <shm_close>
}
80105288:	c9                   	leave  
80105289:	c3                   	ret    
...
801054c9:	c7 44 24 04 81 75 10 	movl   $0x80107581,0x4(%esp)
801054d0:	80 
...
80105560:	ff 24 85 28 76 10 80 	jmp    *-0x7fef89d8(,%eax,4)
80105567:	90                   	nop
    lapiceoi();
    break;
...
801055d3:	c7 04 24 e4 75 10 80 	movl   $0x801075e4,(%esp)
...
801056cc:	c7 04 24 8c 75 10 80 	movl   $0x8010758c,(%esp)
...
8010578a:	c7 04 24 b0 75 10 80 	movl   $0x801075b0,(%esp)
80105791:	89 44 24 04          	mov    %eax,0x4(%esp)
80105795:	e8 b6 ae ff ff       	call   80100650 <cprintf>
      panic("trap");
8010579a:	c7 04 24 86 75 10 80 	movl   $0x80107586,(%esp)
...
80105897:	00 
  for(p="xv6...\n"; *p; p++)
80105898:	bb a8 76 10 80       	mov    $0x801076a8,%ebx
  ioapicenable(IRQ_COM1, 0);
...
8010647a:	c3                   	ret    
        panic("kfree");
8010647b:	c7 04 24 46 70 10 80 	movl   $0x80107046,(%esp)
...
801065c1:	c3                   	ret    
      panic("remap");
801065c2:	c7 04 24 b0 76 10 80 	movl   $0x801076b0,(%esp)
...
801066d1:	c7 04 24 b6 76 10 80 	movl   $0x801076b6,(%esp)
801066d8:	e8 83 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no pgdir");
801066dd:	c7 04 24 e1 76 10 80 	movl   $0x801076e1,(%esp)
801066e4:	e8 77 9c ff ff       	call   80100360 <panic>
    panic("switchuvm: no kstack");
801066e9:	c7 04 24 cc 76 10 80 	movl   $0x801076cc,(%esp)
...
8010677e:	c7 04 24 f5 76 10 80 	movl   $0x801076f5,(%esp)
...
80106832:	c7 04 24 0f 77 10 80 	movl   $0x8010770f,(%esp)
80106839:	e8 22 9b ff ff       	call   80100360 <panic>
    panic("loaduvm: addr must be page aligned");
8010683e:	c7 04 24 b0 77 10 80 	movl   $0x801077b0,(%esp)
...
801068e2:	c7 04 24 2d 77 10 80 	movl   $0x8010772d,(%esp)
...
80106910:	c7 04 24 45 77 10 80 	movl   $0x80107745,(%esp)
...
801069d3:	e9 28 b9 ff ff       	jmp    80102300 <kfree>
    panic("freevm: no pgdir");
801069d8:	c7 04 24 61 77 10 80 	movl   $0x80107761,(%esp)
...
80106abb:	c3                   	ret    
    panic("clearpteu");
80106abc:	c7 04 24 72 77 10 80 	movl   $0x80107772,(%esp)
...
80106ba5:	eb e9                	jmp    80106b90 <copyuvm+0xc0>
      panic("copyuvm: page not present");
80106ba7:	c7 04 24 96 77 10 80 	movl   $0x80107796,(%esp)
80106bae:	e8 ad 97 ff ff       	call   80100360 <panic>
      panic("copyuvm: pte should exist");
80106bb3:	c7 04 24 7c 77 10 80 	movl   $0x8010777c,(%esp)
...
80106c96:	c7 44 24 04 d4 77 10 	movl   $0x801077d4,0x4(%esp)
80106c9d:	80 
...
80106cfe:	8b 75 08             	mov    0x8(%ebp),%esi
  ...
  initlock(&(shm_table.lock), "SHM lock");
80106d01:	c7 44 24 04 d4 77 10 	movl   $0x801077d4,0x4(%esp)
80106d08:	80 
80106d09:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d10:	e8 4b d3 ff ff       	call   80104060 <initlock>
  acquire(&(shm_table.lock));
80106d15:	c7 04 24 c0 54 11 80 	movl   $0x801154c0,(%esp)
80106d1c:	e8 2f d4 ff ff       	call   80104150 <acquire>
80106d21:	eb 10                	jmp    80106d33 <shm_open+0x43>
80106d23:	90                   	nop
80106d24:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
80106d28:	83 c3 0c             	add    $0xc,%ebx

  for (i = 0; i < 64; i++) { 
80106d2b:	81 fb f8 57 11 80    	cmp    $0x801157f8,%ebx
80106d31:	74 65                	je     80106d98 <shm_open+0xa8>
    if (shm_table.shm_pages[i].id == id) {
80106d33:	39 73 fc             	cmp    %esi,-0x4(%ebx)
80106d36:	75 f0                	jne    80106d28 <shm_open+0x38>
      uint pa = (uint)&shm_table.shm_pages[i].frame;
      uint va = PGROUNDUP(myproc()->sz);
80106d38:	e8 73 c9 ff ff       	call   801036b0 <myproc>
80106d3d:	8b 10                	mov    (%eax),%edx
80106d3f:	8d ba ff 0f 00 00    	lea    0xfff(%edx),%edi

      if (mappages(myproc()->pgdir, (void *)va, PGSIZE, pa, PTE_W|PTE_U) == 0) {
80106d45:	e8 66 c9 ff ff       	call   801036b0 <myproc>
      uint va = PGROUNDUP(myproc()->sz);
80106d4a:	81 e7 00 f0 ff ff    	and    $0xfffff000,%edi
      if (mappages(myproc()->pgdir, (void *)va, PGSIZE, pa, PTE_W|PTE_U) == 0) {
80106d50:	c7 44 24 10 06 00 00 	movl   $0x6,0x10(%esp)
80106d57:	00 
80106d58:	89 5c 24 0c          	mov    %ebx,0xc(%esp)
...
80106d75:	74 2d                	je     80106da4 <shm_open+0xb4>
        goto bad;
      }
...
80106d77:	8b 45 0c             	mov    0xc(%ebp),%eax
      shm_table.shm_pages[i].refcnt += 1;
80106d7a:	83 43 04 01          	addl   $0x1,0x4(%ebx)
80106d7e:	83 c3 0c             	add    $0xc,%ebx
      *pointer = (char *)va;
80106d81:	89 38                	mov    %edi,(%eax)
      myproc()->sz += PGSIZE;
80106d83:	e8 28 c9 ff ff       	call   801036b0 <myproc>
80106d88:	81 00 00 10 00 00    	addl   $0x1000,(%eax)
  for (i = 0; i < 64; i++) { 
80106d8e:	81 fb f8 57 11 80    	cmp    $0x801157f8,%ebx
80106d94:	75 9d                	jne    80106d33 <shm_open+0x43>
...
80106d9f:	e8 9c d4 ff ff       	call   80104240 <release>
  
  bad:
    exit();
80106da4:	e8 07 cd ff ff       	call   80103ab0 <exit>
